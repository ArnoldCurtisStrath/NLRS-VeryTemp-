...
public class LectureCommentsHome_Controller {
    ...
    public void initialize1(String adminID1) {
    ...
    private void openUnitFeedBack(String unitName, String adminID) {
        try {
            ...
            controller.setUnitName(unitName,adminID);

            // Create a new stage
            Stage performanceReportStage = new Stage();
            performanceReportStage.setTitle("Lecturer FeedBack");
